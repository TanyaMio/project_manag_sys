package com.packagename.se2.dao;

import com.packagename.se2.models.*;
import org.hibernate.Session;
import org.hibernate.Transaction;
import com.packagename.se2.utils.HibernateSessionFactoryUtil;
...
public class UserDao {
    ...
    public List<Association> findAssociationByArtfRole(ArtfRole ar) {
        List<Association> associations = (List<Association>)  HibernateSessionFactoryUtil.getSessionFactory().openSession().createQuery("FROM Association A WHERE A.artfRole = "+ ar.getId()).list();
        return  associations;
    }
